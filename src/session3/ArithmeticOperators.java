...
public class ArithmeticOperators {
   public  static void main(String[] args ) {
       ...
       int varB = 6;  // valoare de baza B
       int varC = 3;  // valoare de baza C
       int varD = 1; // valoarea de baza D

       // Exemplu de precedent a operatiilor : impartirea se executa inaitea scaderi
       ...
       System.out.println(a += b); // a = a + b ;// Echivalent cu : a = a + b + 13 ;

       // Adaugam 2 la valoarea curent a lui a
       System.out.println(a += 2 ); // a = a + 2 ; //echivalent cu:  a = a + 2 ;

       //Adaugam (b + 13 ) la valoarea lui a
       System.out.println(a += b + 13); // echivalent cu: a = a + b + 13 ;

       //Exemplu cu operatori *= si expresie mai complexa
       ...
       System.out.println(a ++); // afiseaza 1 , apoi a devenit 2 (pot incrementare )
