...
public class UtilsExamples {
    static void main(String[] args) {
     ...
     public static void localDateExamples() {
       ...
       //  DateTimeFormatter formater = DataTimeFormatter.ofPattern("DD-MM-YYYY") ;
        //   LocalDate data =  LocalData.parse(format , formater) ;
      ...
      public static void localDateTimeExample() {
       ...
       //   String dateTimeString = "2015-12-09 19:57" ;
       //   DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH-mm") ;
       //   LocalDateTime parsedDataTime = LocalDateTime.parse(dataTimeString , formatter) ;
      ...
      public static void randomExample(){
          ...
          String[] name = {"Marcela" , "Narcel " , "Ion"} ;
      ...
      public static void durationExamples() {
        ...
        LocalDateTime time2 = time1.plusDays(1).plusHours(5).plusMinutes(346265) ;
