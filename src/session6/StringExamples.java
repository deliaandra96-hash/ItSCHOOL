...
public class StringExamples {
    ...
    public static void stringPool(){
        ...
        System.out.println("str3 location " +System.identityHashCode(str4));
        System.out.println("str3 equals str 4: " +str3.equals(str4));
    ...
    public static void stringOperators(){
        ...
        code4 = code4 + 12 ;
        System.out.println(" valoarea lui cod4 " + code4);
        System.out.println("comparam cade1 cu cod4 : " + (code1 ==code4));
        System.out.println(" comparam cod1 cu cod3 : " + (code1 == code3));
        System.out.println(" comparam cod1 cu cod2 : " + (code1 == code2)) ;
    ...
    public static void stringMethods(){
        ...
        System.out.println("start with Hell ?  " + str1.startsWith("Hell"));
        System.out.println("start with Ha ?" + str1.startsWith("Ha"));
